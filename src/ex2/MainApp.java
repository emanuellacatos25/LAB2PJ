...
public class MainApp
{
    ...
    public static void main(String[] args) throws IOException {
        ...
        PrintStream flux_iesire;

        String linie;
        String grupare;


        //citesti gruparea cautata
        BufferedReader g=new BufferedReader(new InputStreamReader(System.in));
        System.out.println("Introduceti gruparea: ");
        grupare=g.readLine();

        //scriere in fisier
        flux_iesire= new PrintStream("src/ex2/cantec_out.txt");


        //citire din fisier
        flux_intrare=new BufferedReader(new FileReader("src/ex2/cantec_in.txt"));
        ...
        while (linie!=null){
            ...
            if (vers.cautare(grupare)==true){
                vers.random();
                flux_iesire.println(vers.getVers()+" "+vers.numar_cuvinte()+" "+vers.numar_vocale()+" *");
